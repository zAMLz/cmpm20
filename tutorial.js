...
Game.tutorial.prototype={
    create: function() {
        ...
        var winCollisionGroup = this.physics.p2.createCollisionGroup();
        ...
        //trap for tutorial
        trap = this.add.sprite(200, 460, 'diamond');
        this.physics.p2.enableBody(trap);
        trap.body.setCollisionGroup(killCollisionGroup);
        trap.body.collides([isJumpCollisionGroup, playerCollisionGroup]);
