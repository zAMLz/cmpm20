...
Game.level1.prototype = {
    ...
    create: function() {
        ...
        this.terraincreator('fact2',840,1600,playerCollisionGroup,isJumpCollisionGroup,BoxCollisionGroup,true);
        //this.terraincreator('terr-null',1200,1900,playerCollisionGroup,isJumpCollisionGroup,BoxCollisionGroup,false);
        this.terraincreator('fact3',1480,1600,playerCollisionGroup,isJumpCollisionGroup,BoxCollisionGroup,true);
